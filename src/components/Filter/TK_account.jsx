...
const TKFilterComponent = ({ filters, onFilterChange, data }) => {
  ...
  const uniqueTK = [...new Set(data.map((entry) => entry.tk))];
      ...
      <Grid item xs={2} sm={2.4}>
        ...
        <Grid item xs={3} sm={2.4}>
          <Autocomplete
            ...
            onChange={(e, value) => handleAutocompleteChange("tk", value)}
            freeSolo
            value={filters.tk}
            onInputChange={(e, value) => handleAutocompleteChange("tk", value)}
          />
        </Grid>
        <Grid item xs={2.4} sm={2.4}>
          <Autocomplete
            ...
            freeSolo
            value={filters.sex}
            onInputChange={(e, value) => handleAutocompleteChange("sex", value)}
          />
        </Grid>
      </Grid>
    </Box>
